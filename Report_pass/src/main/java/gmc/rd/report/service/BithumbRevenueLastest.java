...
@Service
public class BithumbRevenueLastest extends RevenueLastestService{
	private final ReportRepository reportRepository;
	
	private RevenueStateRepository revenueStateRepository;
	
	public BithumbRevenueLastest(ReportRepository reportRepository, RevenueStateRepository revenueStateRepository) {
	...
	public List<ReportDto> groupCurrency(User user){
		List<Report> report = reportRepository.groupByCurrencyUpdate(user.getMemId());
		List<ReportDto> reportDto = ReportDtoMapper.INSTANCE.toDto(report);
		return reportDto;
	}
	@Override
	public List<ReportDto> findByNull(User user, String currency){
		List<Report> report = reportRepository.findByNull(user.getMemId(), currency);
		List<ReportDto> reportDto = ReportDtoMapper.INSTANCE.toDto(report);
		return reportDto;
	}
	@Override
	public List<ReportDto> findByRow(User user, String currency){
		...
		List<Report> report = reportRepository.findByLatestRow(user.getMemId(), currency);
		List<ReportDto> reportDto = ReportDtoMapper.INSTANCE.toDto(report);
		return reportDto;
	}

	@Override
	public void setAvgPrice(List<ReportDto> bithumbReport_isNull,List<ReportDto> bithumbReport_latestRow,User user) throws ParseException{
