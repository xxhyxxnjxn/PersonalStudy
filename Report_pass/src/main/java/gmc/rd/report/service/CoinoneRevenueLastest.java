...
@Service
public class CoinoneRevenueLastest extends RevenueLastestService{
	...
	public CoinoneRevenueLastest(ReportRepository3 reportRepository3, RevenueStateRepository revenueStateRepository) {
	...
	public List<ReportDto> groupCurrency(User user){
		List<Report3> report = reportRepository3.groupByCurrencyUpdate(user.getMemId());
	...
	public List<ReportDto> findByNull(User user, String currency){
		List<Report3> report = reportRepository3.findByNull(user.getMemId(), currency);
		List<ReportDto> reportDto = ReportDtoMapper3.INSTANCE.toDto2(report);
		return reportDto;
	}
	@Override
	public List<ReportDto> findByRow(User user, String currency){
		...
		List<Report3> report = reportRepository3.findByLatestRow(user.getMemId(), currency);
		List<ReportDto> reportDto = ReportDtoMapper3.INSTANCE.toDto2(report);
		return reportDto;
	}
	
	@Override
	public void setAvgPrice(List<ReportDto> coinoneReport_isNull,List<ReportDto> coinoneReport_latestRow,User user) throws ParseException{
		...
		List<ReportDto> report = setCoinoneData_latest(coinoneReport_isNull, coinoneReport_latestRow);
...
//수익률 업데이트 쿼리문		
	...
	public List<ReportDto> setCoinoneData_latest(List<ReportDto> report,List<ReportDto> coinoneReport_latestRow) {
	...
	public List<ReportDto> replaceNull( List<ReportDto> coinoneReport_latestRow){
