...
$(document).ready(function() {
    $("#now_dateTo, #now_dateFrom").on("change", function () {
	...
	for (i = 0; i < data.length; i++) {
		...
		var searchFilter = data[2].textContent.toString().substr(0, 4) + data[2].textContent.toString().substr(6, 2) + data[2].textContent.toString().substr(10, 2);
    alert(searchFilter);
    } );
 $("#example").DataTable();
