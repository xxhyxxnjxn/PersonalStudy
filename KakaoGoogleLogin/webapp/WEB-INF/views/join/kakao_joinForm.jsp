                ...
                <div class="col-xl-6">
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
							...
							<form class="mt-5 mb-5 login-input" action="/Join/kakao_Join" method="POST">
								...
								<div class="form-group test">
									<input style="width: 100%" type="text" name="name"
										id="name" class="form-control" value="${kakao_name}"
										required="required"  />
								</div>
								...
								<div class="form-group">
									<input type="text" name="email" class="form-control"
										value="${kakao_email}" placeholder="이메일" required="required" />
								</div>
